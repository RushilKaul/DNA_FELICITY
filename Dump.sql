...
ADD FOREIGN KEY (COORDINATOR_ID) REFERENCES STUDENTS(Roll_Number);
...
ALTER TABLE EVENTS
ADD FOREIGN KEY (Event_Name) REFERENCES SCHEDULE(Event_Name);

ALTER TABLE EXPENDITURE
ADD FOREIGN KEY (Event_Number) REFERENCES EVENTS(Event_Number);

ALTER TABLE SPONSOR
ADD FOREIGN KEY (SPONSOR_NAME) REFERENCES INCOME(SPONSOR_NAME);

ALTER TABLE FOOD_STALLS 
ADD FOREIGN KEY (STALL_NAME) REFERENCES INCOME(SPONSOR_NAME);

ALTER TABLE PARTICIPANT_LIST
ADD FOREIGN KEY (SPONSOR_NAME) REFERENCES SPONSOR(SPONSOR_NAME);
...
ADD FOREIGN KEY (STALL_NAME) REFERENCES FOOD_STALLS(STALL_NAME);

ALTER TABLE EVENTS
ADD FOREIGN KEY (ORGANISED_BY) REFERENCES SCHEDULE(ORGANISED_BY);
...
ALTER TABLE COORDINATOR
ADD FOREIGN KEY (COORD_Roll_Number) REFERENCES STUDENTS(Roll_Number);
...
ADD FOREIGN KEY (Event_Name) REFERENCES EVENTS(Event_Name);

ALTER TABLE SCHEDULE
ADD FOREIGN KEY (ORGANISED_BY) REFERENCES EVENTS(ORGANISED_BY);

ALTER TABLE EXPENDITURE
ADD FOREIGN KEY (Event_Number) REFERENCES EVENTS(Event_Number);

ALTER TABLE INCOME
ADD FOREIGN KEY (SOURCE_NAME) REFERENCES FOOD_STALLS(STALL_NAME);

ALTER TABLE INCOME 
ADD FOREIGN KEY (SOURCE_NAME) REFERENCES SPONSOR(STALL_NAME);

ALTER TABLE PARTICIPANT_LIST
ADD FOREIGN KEY (SPONSOR_NAME) REFERENCES SPONSORS(SPONSOR_NAME);
